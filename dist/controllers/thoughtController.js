...
export const removeReaction = async (req, res) => {
    try {
        ...
        const updatedThought = await Thought.findOneAndUpdate({ _id: req.params.thoughtId }, { $pull: { reactions: { reactionId: new mongoose.Types.ObjectId(req.params.reactionId) } } }, { new: true });
